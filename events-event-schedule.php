                    ...
                    statusCode: {
                        200: function(data) {
                            ...
                            for(var i=0, len=rawEvents.length;i < len; i++) {
                                ...
                                //let arrMyDate = rawEvents[i]["Date"].split("T")[0].split("-");
                                //let arrMyDate = rawEvents[i]["Date"].split("T")[0].split("-");
                                //console.log(arrMyDate);
                                let arrMyDate = rawEvents[i]["Date"].split("/");
                                const dateObject = new Date(arrMyDate[2],arrMyDate[0],arrMyDate[1]);
                                //const dateObject = new Date(parseInt(arrMyDate[0]),parseInt(arrMyDate[1]),parseInt(arrMyDate[2]));
                                ...
                                let dateFormatted = rawEvents[i]["Date"].split("T")[0];
                                newEventList.push(
                                    {
                                        id:parseInt(i+1),
