...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl business-results">
          ...
          <div class="d-flex align-items-md-center">
            <div class="flex-grow-1 ms-2">
              <div class="d-md-flex d-sm-inline-block align-items-center">
                ...
                <div class="col-md-3 p-0 ps-md-0">
                  <div class="mb-md-0 mb-3">
                    <div class="tom-select-custom me-3">
                ...
                <div class="col-md-3 p-0 ps-md-0">
                  <div class="mb-md-0 mb-3">
                    <div class="tom-select-custom me-3">
                      <select id="strategySelect" class="js-select form-select" autocomplete="off"
                            data-hs-tom-select-options='{
                              "placeholder": "Select a person...",
                              "hideSearch": true
                            }'>
                ...
                <div class="col-md-3 p-0 ps-md-0">
                  <div class="mb-md-0 mb-3">
                    <div class="tom-select-custom">
                      <select id="formatSelect" class="js-select form-select" autocomplete="off"
                            data-hs-tom-select-options='{
                              "placeholder": "Select a person...",
                              "hideSearch": true
                            }'>
            ...
            <div class="col-lg-6">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <!-- Chart Half -->
                  <div class="chartjs-doughnut-custom" style="height: 12rem;">
                    <canvas id="doughnut-chart-4" class="js-chart"
                        data-hs-chartjs-options='{
                          "type": "doughnut",
                          "data": {
                            "labels": ["", ""],
  ...
  <script>
    ...
    var opportunitiesList = [];var campaignList = [];var countryList = [];var targetList = [];var strategyList = [];var formatList = [];
    ...
    function buildChartData_2(formatSpecialEvent,formatOneToOne,formatOneToFew,formatOffer,formatGeneralForms,formatBlank,formatDigital,formatPhysical){
        labels1 = [];
        data1 = [];
        colors1 = [];
        let allValues = [formatSpecialEvent,formatOneToOne,formatOneToFew,formatOffer,formatGeneralForms,formatBlank,formatDigital,formatPhysical];
        ...
        if(sumRes==0){
            ...
            */
            if(formatSpecialEvent>0){
                labels1.push("Special Event");
                data1.push(formatSpecialEvent);
                colors1.push("#BC58FF");
            }
            if(formatOneToOne>0){
                labels1.push("One-to-One");
                data1.push(formatOneToOne);
                colors1.push("#1A1A1A");
            }
            if(formatOneToFew>0){
                labels1.push("One-to-Few");
                data1.push(formatOneToFew);
                colors1.push("#30A6EF");
            }
            if(formatOffer>0){
                labels1.push("Offer");
                data1.push(formatOffer);
                colors1.push("#38BA75");
            }
            if(formatGeneralForms>0){
                labels1.push("General Forms");
                data1.push(formatGeneralForms);
                colors1.push("#FFB000");
            }
            if(formatBlank>0){
                labels1.push("--");
                data1.push(formatBlank);
                colors1.push("#CF4800");
            }
            if(formatDigital>0){
                labels1.push("Digital");
                data1.push(formatDigital);
                colors1.push("#603085");
            }
            if(formatPhysical>0){
                labels1.push("Physical");
                data1.push(formatPhysical);
                colors1.push("#FF731F");
            }
        ...
        $.ajax ({
				...
				statusCode: {
					200: function(data) {
                            ...
                            console.log(opportunitiesList);
                             /*
                                ...
                                */
                                ...
                                let panamaWon=0;
                                //*********************//
                                let formatSpecialEvent = 0;
                                let formatOneToOne = 0;
                                let formatOneToFew = 0;
                                let formatOffer = 0;
                                let formatGeneralForms = 0;
                                let formatBlank = 0;
                                let formatDigital = 0;
                                let formatPhysical = 0;
                                //*********************//
                                ...
                                for (var i = 0, len = opportunitiesList.length; i < len; i++) {
                                    ...
                                    let formatValue = opportunitiesList[i]['REPORT - Business Results[Format(subcat)]'];
                                ...
                                targetCount++;
                                    ...
                                    if(opportunitiesList[i]['REPORT - Business Results[Status]'] == "Pipeline"){       
                                        ...
                                        if(opportunitiesList[i]['REPORT - Business Results[Strategy (SalesType)]'] == "Acquisition"){
                                            newCustomerCount++;
                                        }
                                        if(opportunitiesList[i]['REPORT - Business Results[Strategy (SalesType)]'] != "Acquisition"){
                                            crossSellCount++;
                                 ...
                                 if(parseFloat(opportunitiesList[i]['REPORT - Business Results[TCV]'])>=0 && parseFloat(opportunitiesList[i]['REPORT - Business Results[MRR]'])>=0){
                                    ...
                                    $(".opportunitiesTbody[status='" + opportunitiesList[i]['REPORT - Business Results[Status]'] + "']").append('<tr formatsubcat="'+opportunitiesList[i]['REPORT - Business Results[Format(subcat)]']+'" strategy="'+opportunitiesList[i]['REPORT - Business Results[Strategy (SalesType)]']+'" campaign="' + opportunitiesList[i]['REPORT - Business Results[Campaign]'] + '" status="' + opportunitiesList[i]['REPORT - Business Results[Status]'] + '" country="'+opportunitiesList[i]['REPORT - Business Results[Country_B]']+'" role="row" class="odd opportunityRows"><td class="sorting_1">' + opportunitiesList[i]['REPORT - Business Results[Account]'] + '</td>\
                                    ...
                                    if($.inArray(opportunitiesList[i]['REPORT - Business Results[Strategy (SalesType)]'], strategyList)==-1){
                                        strategyList.push(opportunitiesList[i]['REPORT - Business Results[Strategy (SalesType)]']);
                                        //console.log(strategyList);
                                        $("#strategySelect").append('<option>' + opportunitiesList[i]['REPORT - Business Results[Strategy (SalesType)]'] + '</option>');
                                    }
                                    if($.inArray(opportunitiesList[i]['REPORT - Business Results[Format(subcat)]'], formatList)==-1 && opportunitiesList[i]['REPORT - Business Results[Status]'] == "Won"){
                                        formatList.push(opportunitiesList[i]['REPORT - Business Results[Format(subcat)]']);
                                        $("#formatSelect").append('<option>' + opportunitiesList[i]['REPORT - Business Results[Format(subcat)]'] + '</option>');
                                    }
                                    ...
                                    if(opportunitiesList[i]['REPORT - Business Results[Status]'] == "Pipeline"){       
                                        ...
                                        if(opportunitiesList[i]['REPORT - Business Results[Strategy (SalesType)]'] == "Upsale/Crossale"){
                                            crossSellPipeline += parseFloat(opportunitiesList[i]['REPORT - Business Results[TCV]']);
                                            //crossSellCount++;
                                        }
                                    }//console.log("type "+opportunitiesList[i]['REPORT - Business Results[Strategy (SalesType)]']);
                                    if(opportunitiesList[i]['REPORT - Business Results[Status]'] == "Won"){
                                ...
                                //console.log("wonFormatTotal: "+ wonFormatTotal);
                                /*
                            ...
                            var ctx4 = document.getElementById("doughnut-chart-4");
                            ...
                            var chartStatus_4 = Chart.getChart("doughnut-chart-4");
                            if (chartStatus_4 != undefined) {
                                chartStatus_4.destroy();
                            }
                            ...
                            var newChart_3 = new Chart(ctx3, {
                                type: 'doughnut',
                                data: {
                                    labels: ["Acquisition","Cross Sell / Upsale"],
                                    datasets: [{
                            ...
                            //console.log("chart 4");
                            chartdata4 = buildChartData_2(formatSpecialEvent,formatOneToOne,formatOneToFew,formatOffer,formatGeneralForms,formatBlank,formatDigital,formatPhysical);
                            var newChart_4 = new Chart(ctx4, {
                                type: 'doughnut',
                                data: {
                                    //labels: ["", ""],
                                    labels: chartdata4.labels,
                                    datasets: [{
                                        "backgroundColor": chartdata4.colors,
...
$( "#content" ).on( "change", "#strategySelect", function() {//console.log("aaa"+$(this).val());
    ...
    //$(".opportunityRows").hide();
    $(".opportunityRows[status='Pipeline']").not($(".opportunityRows[status='Pipeline'][strategy='" + $(this).val() + "']")).attr("visible","hidden").hide();
	//console.log($(this).val());
	$(".opportunityRows[status='Pipeline'][strategy='" + $(this).val() + "']").attr("visible","visible").animate({opacity:1}, 300).show();
	
	if($(this).val()=="Strategy"){$(".opportunityRows[status='Pipeline']").attr("visible","visible").animate({opacity:1}, 300).show();}
    ...
    $(".opportunityRows[status='Won']").not($(".opportunityRows[status='Won'][strategy='" + $(this).val() + "']")).attr("visible","hidden").hide();
	//console.log($(this).val());
	$(".opportunityRows[status='Won'][strategy='" + $(this).val() + "']").attr("visible","visible").animate({opacity:1}, 300).show();
	
	if($(this).val()=="Strategy"){$(".opportunityRows[status='Won']").attr("visible","visible").animate({opacity:1}, 300).show();}
    ...
    for (var i = 0, len = opportunitiesList.length; i < len; i++) {
        ...
        if((opportunitiesList[i]['REPORT - Business Results[Strategy (SalesType)]'] == $(this).val() || $(this).val() == "Strategy")){
            let country = opportunitiesList[i]['REPORT - Business Results[Country_B]'];
            let formatValue = opportunitiesList[i]['REPORT - Business Results[Format(subcat)]'];
            let _tcv = opportunitiesList[i]['REPORT - Business Results[TCV]'];
            if(_tcv>=0){
...
$( "#content" ).on( "change", "#formatSelect", function() {//console.log("aaa"+$(this).val());
    ...
    //$(".opportunityRows").hide();
    $(".opportunityRows[status='Pipeline']").not($(".opportunityRows[status='Pipeline'][formatsubcat='" + $(this).val() + "']")).attr("visible","hidden").hide();
	//console.log($(this).val());
	$(".opportunityRows[status='Pipeline'][formatsubcat='" + $(this).val() + "']").attr("visible","visible").animate({opacity:1}, 300).show();
	
	if($(this).val()=="Format"){$(".opportunityRows[status='Pipeline']").attr("visible","visible").animate({opacity:1}, 300).show();}
    ...
    $(".opportunityRows[status='Won']").not($(".opportunityRows[status='Won'][formatsubcat='" + $(this).val() + "']")).attr("visible","hidden").hide();
	//console.log($(this).val());
	$(".opportunityRows[status='Won'][formatsubcat='" + $(this).val() + "']").attr("visible","visible").animate({opacity:1}, 300).show();
	
	if($(this).val()=="Format"){$(".opportunityRows[status='Won']").attr("visible","visible").animate({opacity:1}, 300).show();}
    ...
    for (var i = 0, len = opportunitiesList.length; i < len; i++) {
        ...
        if((opportunitiesList[i]['REPORT - Business Results[Format(subcat)]'] == $(this).val() || $(this).val() == "Format")){
            let country = opportunitiesList[i]['REPORT - Business Results[Country_B]'];
            let formatValue = opportunitiesList[i]['REPORT - Business Results[Format(subcat)]'];
            let _tcv = opportunitiesList[i]['REPORT - Business Results[TCV]'];
            if(_tcv>=0){
