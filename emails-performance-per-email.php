...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h1 class="page-header-title">Content Distribution / EMAILS</h1>
            ...
            <div class="row">
                <div class="col-md-9">
                            ...
                            <div class="d-flex align-items-md-center">
                                <div class="flex-grow-1 ms-2">
                                    <div class="d-md-flex d-sm-inline-block align-items-center">
                                            ...
                                            <div class="mb-md-0 mb-3">
                                                <div class="d-md-flex d-sm-inline-block" role="group" aria-label="Basic radio toggle button group">
                                                    <div class="mb-3 mb-md-0">
                                                        ...
                                                        <label class="btn btn-outline-primary btn-outline-check me-3" for="btnContent">By content type</label>
                                                    </div>
                                        ...
                                        <!-- <div class="d-md-flex d-sm-inline-flex type-analysis" id="byContenttype"> -->
                                        <div class="type-analysis type-content" id="byContenttype">
                                       
                                        </div>

                                        <!-- <div class="d-md-flex d-sm-inline-flex type-analysis" id="byPerformance"> -->
                                        <div class="type-analysis d-none" id="byPerformance">
                                            <div>
                                                <div class="d-inline-flex align-items-center">
                                                    ...
                                                    <div><p class="mb-0 me-3 fw-bold">Overperformed</p></div>
                                                </div>
                                                ...
                                                <div class="d-inline-flex align-items-center">
                                                    ...
                                                    <div><p class="mb-0 me-3 fw-bold">Average performance</p></div>
                                                </div>
                                            </div>
                                            <div>
                                                <div class="d-inline-flex align-items-center">
                                                    ...
                                                    <div><p class="mb-0 me-3 fw-bold">Underperformed</p></div>
                                                </div>
                                                ...
                                                <div class="d-inline-flex align-items-center">
                                                    ...
                                                    <div><p class="mb-0 me-3 fw-bold">Pending</p></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <!-- BEGIN EMAILS -->
                    <div class="row mb-3 mb-md-4 emails-container">
                ...
                <div class="col-md-3">
                    ...
                    <div class='card mb-3 mb-lg-5 sticky-bar-stats '>
                        ...
                        <div class='card-body py-3'>
                            <div><p class="mb-3 fw-bold">Filter</p></div>
                            ...
                            <div>
                                <select id="dropCampaign" class="form-select" aria-label="Default select example">
                            ...
                            <div class="mb-3">
                                <div class="accordion" id="accordionInfo">
                                    ...
                                    <div class="accordion-item" id="send-combined">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                ...
                                                <ul id="combined-stats" class="list-group list-group-flush list-group-no-gutters d-none">
                                                    <li class="list-group-item pt-0">
                                                        <div class="d-flex justify-content-center align-items-center">
                                                            <div class="col-6 me-3">
                                                                <h5 class="card-title mb-0 fs-15 text-end">Delivered</h5>
                                                            </div>
                                                            <div class="col-6">
                                                                <h5 id="combine-delivered" class="card-title mb-0 fs-20 text-start"></h5>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="list-group-item d-none">
                                                        <div class="d-flex justify-content-center align-items-center">
                                                            <div class="col-6 me-3">
                                                                <h5 class="card-title mb-0 fs-15 text-end fw-normal">Rate</h5>
                                                            </div>
                                                            
                                                            <div class="col-6">
                                                                <h5 id="combine-rate-delivered" class="card-title mb-0 fs-15 text-start fw-bold">%</h5>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="list-group-item pb-2">
                                                        <div class="d-flex justify-content-center align-items-end">
                                                            <div class="col-6 me-3">
                                                                <h5 class="card-title mb-0 fs-15 text-end fw-bold">Opens</h5>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="d-flex align-items-end">
                                                                    <div class="me-2">
                                                                        <h5 id="combine-open" class="card-title mb-0 fs-20 text-start fw-bold"></h5>
                                                                    </div>
                                                                    <div>
                                                                        <h5 id="combine-rate-open" class="card-title mb-0 fs-15 text-start fw-bold">%</h5>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li class="list-group-item border-0 pt-2">
                                                        <div class="d-flex justify-content-center align-items-end">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="d-flex align-items-end">
                                                                    <div class="me-2">
                                                                        <h5 id="combine-open_b" class="card-title mb-0 fs-20 text-start fw-bold"></h5>
                                                                    </div>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="me-1">
                                                                            <img src="./assets/img/icos/ico-up-circle-green.svg" alt="" id="combine-open_b_icon">
                                                                        </div>
                                                                        <div>
                                                                            <h5 id="combine-rate-open_b" class="card-title mb-0 fs-15 text-start fw-normal text-green">%</h5>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li class="list-group-item pt-0">
                                                        <div class="d-flex justify-content-center align-items-end">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="d-flex align-items-end">
                                                                    <div class="me-2">
                                                                        <h5 id="combine-open_h" class="card-title mb-0 fs-20 text-start fw-bold"></h5>
                                                                    </div>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="me-1">
                                                                            <img src="./assets/img/icos/ico-down-circle-red.svg" alt="" id="combine-open_h_icon">
                                                                        </div>
                                                                        <div>
                                                                            <h5 id="combine-rate-open_h" class="card-title mb-0 fs-15 text-start fw-normal text-red">%</h5>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li class="list-group-item pb-2">
                                                        <div class="d-flex justify-content-center align-items-end">
                                                            <div class="col-6 me-3">
                                                                <h5 class="card-title mb-0 fs-15 text-end fw-bold">Clicks</h5>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="d-flex align-items-end">
                                                                    <div class="me-2">
                                                                        <h5 id="combine-click" class="card-title mb-0 fs-20 text-start fw-bold"></h5>
                                                                    </div>
                                                                    <div>
                                                                        <h5 id="combine-rate-click" class="card-title mb-0 fs-15 text-start fw-bold">%</h5>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li class="list-group-item border-0 pt-2">
                                                        <div class="d-flex justify-content-center align-items-end">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="d-flex align-items-end">
                                                                    <div class="me-2">
                                                                        <h5 id="combine-click_b" class="card-title mb-0 fs-20 text-start fw-bold"></h5>
                                                                    </div>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="me-1">
                                                                            <img src="./assets/img/icos/ico-up-circle-green.svg" alt="" id="combine-click_b_icon">
                                                                        </div>
                                                                        <div>
                                                                            <h5 id="combine-rate-click_b" class="card-title mb-0 fs-15 text-start fw-normal text-green">%</h5>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li class="list-group-item py-0">
                                                        <div class="d-flex justify-content-center align-items-end">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="d-flex align-items-end">
                                                                    <div class="me-2">
                                                                        <h5 id="combine-click_h" class="card-title mb-0 fs-20 text-start fw-bold"></h5>
                                                                    </div>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="me-1">
                                                                            <img src="./assets/img/icos/ico-down-circle-red.svg" alt="" id="combine-click_h_icon">
                                                                        </div>
                                                                        <div>
                                                                            <h5 id="combine-rate-click_h" class="card-title mb-0 fs-15 text-start fw-normal text-red">%</h5>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <!-- End COMBINE ITEMS -->
                                    <!-- COMPARE ITEMS -->
                                    <div class="accordion-item d-none" id="send-compared">
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div><p class="mb-0 fw-bold">Email comparison (top 5)</p></div>
                                                ...
                                                <div class="chartjs-custom">
                                                    <canvas id="emailComparison" class="js-chart" style="height: 500px !important;"
                                                        data-hs-chartjs-options='{
                                                              "type": "bar",
                                                              "data": {
                                                                "labels": ["Email 5", "Email 4", "Email 3", "Email 2", "Email 1"],
                                                                "datasets": [{
  ...
  <script src="./assets/js/content-emails-analysis.js"></script>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var savedBorders = [];
      var elements = document.querySelectorAll('.border-img-purple-light, .border-img-purple, .border-img-red-dark');
