<?php
    ...
    $latest_time = 0; 
    $latest_filename="**";
    foreach (scandir('oppty', SCANDIR_SORT_DESCENDING) as $file){
        $t = filectime('oppty/'.$file);
    ...
    $pathAndFile = 'oppty/'.$latest_filename;
    
    //abrimos archivo existente (que luego será copiado a 1drv por el Flow)
    $compositePath = "composites/OPPS IN CAMPAIGN LATAM.csv";
